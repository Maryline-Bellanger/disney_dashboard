import { deleteSerie } from '@/app/lib/marvel/series/actions-marvel-series';
...
export function DeleteSerie({ id }: { id: string }) {
    const deleteMarvelSerieWithId = deleteSerie.bind(null, id);
    return (
        <form action={deleteMarvelSerieWithId}>
