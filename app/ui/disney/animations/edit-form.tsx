...
import { updateAnimation } from "@/app/lib/disney/animations/actions-disney-animations";
                    ...
                    <div className="relative mt-2 rounded-md">
                        <div className="relative">
                            <input
                                ...
                                defaultValue={disneyAnimation.tmdb_id}
                            />
                        </div>
                    </div>
                </div>
                    ...
                    <div className="relative mt-2 rounded-md">
                        <div className="relative">
                            <input
                                ...
                                type="text"
                                className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
                                defaultValue={disneyAnimation.title}
                            />
                        </div>
                    </div>
                </div>
                    ...
                    <div className="relative mt-2 rounded-md">
                        <div className="relative">
                            <input
                                ...
                                type="date"
                                className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
                                defaultValue={disneyAnimation.date}
                            />
                        </div>
                    </div>
                </div>
