import { deleteSerie } from '@/app/lib/disney/series/actions-disney-series';
...
export function DeleteSerie({ id }: { id: string }) {
    const deleteDisneySerieWithId = deleteSerie.bind(null, id);
    return (
        <form action={deleteDisneySerieWithId}>
